        ...
        btnDom.unbind('click').bind('click', function () {
            ...
            if($('#verification').css('display')=='block'){
                ...
                if (!uid) {
                    ...
                    $('#verification_error').parent().find("input").focus();
                    $(".mimiError").hide();
